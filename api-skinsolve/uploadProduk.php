...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['gambar_wajah']['name'])) {
        $file_name = $_FILES['gambar_wajah']['name'];
        $file_tmp = $_FILES['gambar_wajah']['tmp_name'];
        ...
        if (move_uploaded_file($file_tmp, $file_path)) {
            ...
            $sql = "INSERT INTO skin_progres_wajah (gambar_wajah, tanggal_upload, id_user) VALUES (:gambar_wajah, :tanggal_upload, :id_user)";
            $stmt = $pdo->prepare($sql);
            
            // Mengikat nilai parameter
            $stmt->bindParam(':gambar_wajah', $file_name);
