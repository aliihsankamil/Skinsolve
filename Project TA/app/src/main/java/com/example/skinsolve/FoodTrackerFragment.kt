...
class FoodTrackerFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_food_tracker, container, false)
    }
    ...
    private fun uploadImage(imageUri: Uri) {
        ...
        val multipartBody = MultipartBody.Part.createFormData("gambar_makanan", file.name, requestBody)
        ...
        RetrofitClient.apiService.uploadImage(multipartBody, userId).enqueue(object : Callback<ResponseBody> {
